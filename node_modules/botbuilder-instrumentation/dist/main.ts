...
export class BotFrameworkInstrumentation {
  ...
  private appInsightsClients: typeof ApplicationInsights.client;
  ...
  constructor(settings?: IInstrumentationSettings) {
    ...
    this.instrumentationKeys = settings.instrumentationKey || process.env.APP_INSIGHTS_INSTRUMENTATION_KEY
  ...
  private setupInstrumentation() {
    ...
    this.appInsightsClient = ApplicationInsights.getClient(instrumentationKey);
  }
  ...
  private trackEvent(
    ...
    console.log("CLIENT", this.instrumentationKey, "EVENT :", name, "PROPS:", JSON.stringify(properties, null, 2))
  ...
  private trackTrace(
    ...
    tagOverrides?: { [key: string]: string; },
    contextObjects?: { [name: string]: any; }): void {
    console.log("CLIENT", this.instrumentationKey, "EVENT :", message, "SEC-LEVEL: ", severityLevel, "PROPS :", JSON.stringify(properties, null, 2))
  ...
  private trackException(
    ...
    tagOverrides?: { [key: string]: string; },
    contextObjects?: { [name: string]: any; }): void {
    console.log("CLIENT", this.instrumentationKey, "EVENT:", exception, "EXCEPTION: ", exception, "PROPS :", JSON.stringify(properties, null, 2))
